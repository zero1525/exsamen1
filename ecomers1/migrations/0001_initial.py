    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, verbose_name='цена')),
                ('img', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Изоброжения')),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecomers1.brand', verbose_name='бренд')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecomers1.category', verbose_name='категория')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecomers1.goods', verbose_name='товар')),
            ],
            options={
